...
class WebSearch(Skill):
    ...
    def execute(self, params, dependent_task_outputs, objective):
        ...
        query = self.text_completion_tool(
            "You are an AI assistant tasked with generating a short and simple Google search query based on the following task: "
            + params
            + "."
            + dependent_task
        ...
        search_results = self.simplify_search_results(
    ...
    def web_scrape_tool(self, params):
        ...
        info = self.extract_relevant_info(
            params["objective"], text[0:11000], params["task"]
        )
