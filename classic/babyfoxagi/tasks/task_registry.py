...
class TaskRegistry:
    ...
    def create_tasklist(self, objective, skill_descriptions):
        ...
        (
            ...
            example_tasklist,
            example_reflection,
        ) = self.load_example_objectives(objective)
    ...
    def reflect_tasklist(self, objective, task_list, task_outputs, skill_descriptions):
        ...
        try:
            ...
            with open(
                f'tasks/example_objectives/improved_{datetime.now().strftime("%Y%m%d%H%M%S")}.json',
                "w",
            ) as f:
...
class ExampleObjectivesLoader:
        ...
        for filename in os.listdir(self.objectives_folder_path):
            ...
            with open(file_path, "r") as file:
                ...
                for objective in objectives:
                    ...
                    if key not in objectives_dict or (
                        date
                        and datetime.strptime(objectives_dict[key]["date"], "%Y-%m-%d")
                        < date
                    ):
    ...
    def find_most_relevant_objective(self, user_input):
        ...
        return (
            most_relevant_objective["objective"],
            most_relevant_objective["examples"],
            most_relevant_objective.get("reflection", ""),
        )
