...
def parse_arguments():
    ...
    if cooperative_mode in ["l", "local"] and not can_import(module_name):
        print(
            "\033[91m\033[1m"
            + f"Local cooperative mode requires package {module_name}\nInstall:  pip install -r extensions/requirements.txt\n"
            + "\033[0m\033[0m"
        )
        parser.print_help()
        parser.exit()
        ...
        print(
            "\033[91m\033[1m"
            + "Distributed cooperative mode is not implemented yet\n"
            + "\033[0m\033[0m"
        )
        parser.print_help()
        parser.exit()
    ...
    if join_existing_objective and cooperative_mode in ["n", "none"]:
        print(
            "\033[91m\033[1m"
            + f"Joining existing objective requires local or distributed cooperative mode\n"
            + "\033[0m\033[0m"
        )
        parser.print_help()
        parser.exit()
